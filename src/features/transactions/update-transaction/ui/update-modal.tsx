...
export function UpdateTransactionModal({ transaction, isOpen, onClose }: CreateAccountModalProps) {
	...
	return (
		<ModalWrapper
			...
			bottomActions={[
				{
					text: isPending ? 'Updating transaction...' : 'Update Transaction',
					type: 'submit',
					disabled: isPending,
				},
			]}
			...
			onClose={onClose}>
			<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-between'>
				<div className='flex flex-col gap-4'>
					...
					<FormField label='Description' tag='description' description='Give your description' error={errors.description}>
						<Input
							id='title'
							type='text'

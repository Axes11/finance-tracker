...
function SelectTrigger({
	...
	return (
		<SelectPrimitive.Trigger
			...
			data-size={size}
			className={cn(
				"border-border data-[placeholder]:text-muted-foreground/50 [&_svg:not([class*='text-'])]:text-muted-foreground focus-visible:border-foreground focus-visible:ring-0 aria-invalid:border-destructive flex h-12 w-full items-center justify-between gap-2 border bg-transparent px-4 text-[0.88rem] font-sans whitespace-nowrap transition-colors outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			{...props}>
			{children}
